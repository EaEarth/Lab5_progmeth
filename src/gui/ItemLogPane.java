...
public class ItemLogPane extends StackPane {
	...
	public void addData(String itemName, int amountAdded, int totalAmount) {
		Label newLabel = new Label(); // TODO Adds new Label with specific format
		newLabel.setText("Log#"+count+": "+amountAdded+" "+itemName+"(s) were added to the inventory. ("+totalAmount+")");
		count++;
